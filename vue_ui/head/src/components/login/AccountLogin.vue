<template>
    <div style="width: 80%;margin: 0 auto">
        <el-form status-icon class="demo-ruleForm" ref="form" :model="form" label-width="80px">
            <el-form-item
                    prop="name"
                    :rules="validator_rules.account"
                    :label-width="formLabelWidth">
                <el-input placeholder="账号" v-model="form.name" prefix-icon="el-icon-user" clearable></el-input>
            </el-form-item>
            <el-form-item
                    prop="password"
...
<script>
    export default {
        ...
        methods: {
            ...
            setComName(){
                this.$emit('setComName','AccountRegister')
            }
        }
    }
</script>
